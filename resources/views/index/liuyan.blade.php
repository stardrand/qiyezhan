...
<div class="container mg-t-b container_col">
  <div class="page-left">
   ...
   <div class="page-right">
     ...
     <div class="news-txt ny mg-t-b" id="liuyan">
  ...
  <form action="" method="post" name="new" id="new"></form><tbody><tr>
    <td width="569" height="38" align="center" bgcolor="#F4F4F4" class="kkkk1">
      ...
      <input type="radio" value="1" v-model="phiz" name="face">
      <img border="0" src="../images/face2.gif">

	  <input type="radio" value="2" v-model="phiz" name="face">
      <img border="0" src="../images/face1.gif">

      <input type="radio" value="3" v-model="phiz" name="face">
      <img border="0" src="../images/face3.gif">

      <input type="radio" value="4" v-model="phiz" name="face">
      <img border="0" src="../images/face4.gif">

      <input type="radio" value="5" v-model="phiz" name="face">
      <img border="0" src="../images/face5.gif">

      <input type="radio" value="6" v-model="phiz" name="face">
      <img border="0" src="../images/face6.gif">

      <input type="radio" value="7" v-model="phiz" name="face">
      <img border="0" src="../images/face7.gif">

      <input type="radio" value="8" v-model="phiz" name="face">
      <img border="0" src="../images/face8.gif">

      <input type="radio" value="9" v-model="phiz" name="face">
      <img border="0" src="../images/face9.gif">

      <input type="radio" value="10" v-model="phiz" name="face">
    <img border="0" src="../images/face10.gif"> </td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tbody><tr>
        ...
        <td colspan="2">
		<input name="name" type="text" v-model="name" class="input1" size="52" maxlength="20" style="width:95%; border:#999999 dashed 1px; color:#666666; padding:5px; outline:none;" placeholder="请输入您的姓名，不填写为匿名发表">
		</td>
      </tr>
      <tr>
        <td align="center">留　言：</td>
        <td colspan="2"><textarea name="words" v-model="content" cols="50" rows="7" style="width:95%; border:#999999 dashed 1px; color: #5C5C5C; line-height:20px; padding:5px; outline:none;"></textarea></td>
      </tr>
      ...
      <tr>
        ...
        <td colspan="2"><span class="font8">
          ...
          <input type="submit" name="Submit2" @click="liuyan" value="发表留言"></div></span></td>
      </tr>
    </tbody></table></td>
  </tr>
</tbody></table>
